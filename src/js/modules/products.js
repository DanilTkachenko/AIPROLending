export function products() {
  ...
  const monthsArray = {
    ...
    sixMonths: {
      ...
      discount: ["-25%", "-30%", "-32%"],
      cardProfitforUSD: [
        `<span>$90</span> $66 for 6 months`,
        `<span>$120</span> $84 for 6 months`,
        `<span>$180</span> $120 for 6 months`,
      ],

      cardProfitforEUR: [
        `<span>€83</span> €61 for 6 months`,
        `<span>€110</span> €77 for 6 months`,
        `<span>€166</span> €110 for 6 months`,
      ],

      cardProfitforUAH: [
        `<span>₴3410</span> ₴2500 for 6 months`,
        `<span>₴4545</span> ₴3180 for 6 months`,
        `<span>₴3790</span> ₴4545 for 6 months`,
      ],
    ...
    oneYear: {
      ...
      cardProfitforUSD: [
        `<span>$145</span> $96 for 12 months`,
        `<span>$240</span> $132 for 12 months`,
        `<span>$360</span> $200 for 12 months`,
      ],

      cardProfitforEUR: [
        `<span>€134</span> €88 for 12 months`,
        `<span>€220</span> €122 for 12 months`,
        `<span>€332</span> €185 for 12 months`,
      ],

      cardProfitforUAH: [
        `<span>₴5490</span> ₴3635 for 12 months`,
        `<span>₴9090</span> ₴5000 for 12 months`,
        `<span>₴13 635</span> ₴7575 for 12 months`,
      ],
